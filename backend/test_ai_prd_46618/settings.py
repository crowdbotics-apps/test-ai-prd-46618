"""
Django settings for test_ai_prd_46618 project.
...
ROOT_URLCONF = 'test_ai_prd_46618.urls'
...
WSGI_APPLICATION = 'test_ai_prd_46618.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_ai_prd_46618 API",
    "DESCRIPTION": "API documentation for test_ai_prd_46618 App",
    "VERSION": "v1",
}
